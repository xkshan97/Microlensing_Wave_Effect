    ...
    for subImageIndex in range(int(imagenum[ImageIndex])):
        if SNR_network[IndexSumimage] >= 12:
            ...
            try:
                ...
                f0=open('./MicroField_' + max_mass + '/AveMassAndNum_%.2f_%.2f_%.2f_%.2f_1.00.bin'%(kappa, gamma, 1.2*kappaStar_stellar, LensRedshift),"rb")
                ...
                if 1 - kappa - gamma > 0:                
                    ...
                    f1=open('./ResultMinimum_' + max_mass + '/TimeLength_min_%.2f_%.2f_%.2f_%.2f_1.00.bin'%(kappa, gamma, 1.2*kappaStar_stellar, LensRedshift),"rb")
                    TimeLengthFile_min=struct.unpack("l"*1, f1.read(8*1))
                    f1.close()
                    TimeLengthFile_min = np.array(TimeLengthFile_min)
                    fileArea = "./ResultMinimum_" + max_mass + "/adptive_Area_min_%.2f_%.2f_%.2f_%.2f_1.00.bin"%(kappa, gamma, 1.2*kappaStar_stellar, LensRedshift)
                    fileTime = "./ResultMinimum_" + max_mass + "/adptive_Time_min_%.2f_%.2f_%.2f_%.2f_1.00.bin"%(kappa, gamma, 1.2*kappaStar_stellar, LensRedshift)
                    ...
                    np.savetxt('./Freq_Time_Domain_Result_' + max_mass + '/Sta_Minimum_time_%.2f_%.2f_%.2f_%.2f.csv'%(kappa, gamma, 1.2*kappaStar_stellar, LensRedshift),time_new,delimiter=',')
                    np.savetxt('./Freq_Time_Domain_Result_' + max_mass + '/Sta_Minimum_Ft_%.2f_%.2f_%.2f_%.2f.csv'%(kappa, gamma, 1.2*kappaStar_stellar, LensRedshift),Ft_new,delimiter=',')
                    ...
                    np.savetxt('./Freq_Time_Domain_Result_' + max_mass + '/Sta_Minimum_Ffabs_%.2f_%.2f_%.2f_%.2f.csv'%(kappa, gamma, 1.2*kappaStar_stellar, LensRedshift),Ffabs,delimiter=',')
                    np.savetxt('./Freq_Time_Domain_Result_' + max_mass + '/Sta_Minimum_ThetaF_%.2f_%.2f_%.2f_%.2f.csv'%(kappa, gamma, 1.2*kappaStar_stellar, LensRedshift),ThetaF,delimiter=',')
                else:
                    
                    f0=open('./ResultSaddle_' + max_mass + '/X1020New_%.2f_%.2f_%.2f_%.2f_1.00.bin'%(kappa, gamma, 1.2*kappaStar_stellar, LensRedshift),"rb")
                    ...
                    f1=open('./ResultSaddle_' + max_mass + '/TimeLength_sad_%.2f_%.2f_%.2f_%.2f_1.00.bin'%(kappa, gamma, 1.2*kappaStar_stellar, LensRedshift),"rb")
                    TimeLengthFile_min=struct.unpack("l"*1, f1.read(8*1))
                    f1.close()
                    TimeLengthFile_min = np.array(TimeLengthFile_min)
                    fileArea = "./ResultSaddle_" + max_mass + "/adptive_Area_sad_%.2f_%.2f_%.2f_%.2f_1.00.bin"%(kappa, gamma, 1.2*kappaStar_stellar, LensRedshift)
                    fileTime = "./ResultSaddle_" + max_mass + "/adptive_Time_sad_%.2f_%.2f_%.2f_%.2f_1.00.bin"%(kappa, gamma, 1.2*kappaStar_stellar, LensRedshift)
                    ...
                    np.savetxt('./Freq_Time_Domain_Result_' + max_mass + '/Sta_Saddle_time_%.2f_%.2f_%.2f_%.2f.csv'%(kappa, gamma, 1.2*kappaStar_stellar, LensRedshift),time_new,delimiter=',')
                    np.savetxt('./Freq_Time_Domain_Result_' + max_mass + '/Sta_Saddle_Ft_new_%.2f_%.2f_%.2f_%.2f.csv'%(kappa, gamma, 1.2*kappaStar_stellar, LensRedshift),Ft_subtract,delimiter=',')
                    ...
                    np.savetxt('./Freq_Time_Domain_Result_' + max_mass + '/Sta_Saddle_Ffabs_%.2f_%.2f_%.2f_%.2f.csv'%(kappa, gamma, 1.2*kappaStar_stellar, LensRedshift),Ffabs,delimiter=',')
                    np.savetxt('./Freq_Time_Domain_Result_' + max_mass + '/Sta_Saddle_ThetaF_%.2f_%.2f_%.2f_%.2f.csv'%(kappa, gamma, 1.2*kappaStar_stellar, LensRedshift),ThetaF,delimiter=',')
            except FileNotFoundError:
                print('FileNotFoundError ImageIndex = ' + str(ImageIndex) + ' IndexSumimage = ' +  str(IndexSumimage))
                pass
